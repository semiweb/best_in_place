...
BestInPlaceEditor.prototype = {
  ...
  abortIfConfirm : function () {
    if (this.confirmCancel && confirm(this.confirmCancel)) {
      this.abort();
    } else {
      this.abort();
    }
  ...
  initOptions : function() {
    ...
    self.element.parents().each(function(){
      ...
      self.confirmCancel      = self.confirmCancel      || $parent.attr("data-confirm");
    ...
    self.confirmCancel      = self.element.attr("data-confirm-cancel") || self.confirmMessage || null;
